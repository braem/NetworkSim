...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.dockNodeProperties.setGeometry(QtCore.QRect(580, 10, 211, 141))
        ...
        self.dockConnectionProperties.setGeometry(QtCore.QRect(580, 150, 211, 171))
        ...
        self.txtConnectionLength.setGeometry(QtCore.QRect(108, 50, 61, 21))
        ...
        self.txtConnectionBandwidth.setGeometry(QtCore.QRect(108, 80, 61, 21))
        ...
        self.btnModifyConnection.setGeometry(QtCore.QRect(150, 110, 62, 23))
        ...
        self.btnAddConnection.setGeometry(QtCore.QRect(14, 110, 62, 23))
        ...
        self.btnDeleteConnection.setGeometry(QtCore.QRect(82, 110, 62, 23))
        ...
        if (x2 - x1) > 0:  # x direction from node 1 to node 2 is positive
            if (y2 - y1) > 0:  # y direction from node 1 to node 2 is positive
                ...
                if (x2 - x1) > (y1 - y2):  # line in x direction is longer than y
                    ...
                    self.drawVerticalLine(x1, y2, (y1 - y2 + 6), connectionColor, connectionID)
                    self.drawHorizontalLine(x1, y2, (x2 - x1), connectionColor, connectionID)
            ...
            if (y2 - y1) > 0:  # y direction from node 1 to node 2 is positive
                if (x1 - x2) > (y2 - y1):  # line in x is longer than y
                    ...
                    self.drawVerticalLine(x1, y1, (y2 - y1), connectionColor, connectionID)
                    self.drawHorizontalLine(x2, y2, (x1 - x2 + 6), connectionColor, connectionID)
            else:  # y direction from node 1 to node 2 is negative
